...
import { 
    ...
    ArrowUpRight, CreditCard, Key, Save, AlertTriangle, CheckCircle
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white flex font-sans">
      ...
      <main className="flex-1 p-8 overflow-y-auto relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
            ...
            {/* 1. FORMULARIO DE CLAVES (NUEVO) */}
            <form onSubmit={handleSaveKeys} className="lg:col-span-3 bg-slate-900/50 border border-slate-800 p-6 rounded-2xl shadow-xl mb-4">
